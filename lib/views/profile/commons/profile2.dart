...
class Profile1InfoCard extends StatelessWidget {
  final firstText, secondText, hasImage, imagePath;
  final Function onPressed;

  const Profile1InfoCard({Key? key, this.firstText, required this.onPressed, this.secondText, this.hasImage = false, this.imagePath}) : super(key: key);
