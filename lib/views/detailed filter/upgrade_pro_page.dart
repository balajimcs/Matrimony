...
class EnlargeStrategyDemo extends StatefulWidget {
   @override
  EnlargeStrategyDemoState createState() => EnlargeStrategyDemoState();
}

class EnlargeStrategyDemoState extends State<EnlargeStrategyDemo> {
final controller = Get.find<PackageController>();
  var _razorpay = Razorpay();
  
  // InstamojoFlutter.setKeys(apiKey: 'YOUR_API_KEY', authToken: 'YOUR_AUTH_TOKEN');
  var amount = 500;
  @override
  void initState(){
