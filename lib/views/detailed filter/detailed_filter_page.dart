...
class DetailedFilterState extends State<DetailedFilter> {
  ...
  final controller = Get.find<DetailedFilterController>();
        ...
        child: Stack(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Container(
                child: StreamBuilder<List<DetailedFilterModel>>(
                      ...
                      switch (snapshot.connectionState) {
                        ...
                        default:
                          if (snapshot.hasError) {
                            ...
                            List<DetailedFilterModel> foodList = snapshot.data!
                                .where((item) =>
                                    item.firstName!.toLowerCase().contains(controller.searchController.text.toLowerCase()) ||
                                    item.lastName!.toLowerCase().contains(
                                        controller.searchController.text
                                            .toLowerCase()) ||
                                    item.customer_id!.toLowerCase().contains(
                                        controller.searchController.text
                                            .toLowerCase()) ||
                                    item.caste!.toLowerCase().contains(
                                        controller.searchController.text
                                            .toLowerCase()) ||
                                ...
                                : ListView.builder(
                                  controller: _scrollController,
                                    ...
                                    itemBuilder:
                                      ...
                                      //  print("aaaaa: ${food.attachements![0].url}");
                                      return InkWell(
                                        onTap: () {
                                          Navigator.push(
                                              context,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              child: Text(
                                                                                ...
                                                                                style: TextStyle(fontFamily: "Raleway", fontWeight: FontWeight.bold, color: Colors.black, fontSize: 17),
                                                                              ),
                                                                            ),
                                                                            SizedBox(
                                                                              height: 25,
                                                                                  ...
                                                                                  Row(
                                                                                    children: [
                                                                                      ...
                                                                                      ElevatedButton(
                                                                                        ...
                                                                                        child: Text('okay'.tr),
                                                                                        onPressed: () {
                                                                                          controller.addWishListProposal(food.userId, context);
                                                                                      ...
                                                                                      Row(
                                                                                        children: [
                                                                                          ...
                                                                                          ElevatedButton(
                                                                                            ...
                                                                                            child: Text('okay'.tr),
                                                                                            onPressed: () {
                                                                                              controller.removeWishListProposal(food.requestWishList![0].id, context);
                                                              ...
                                                              children: [
                                                                Container(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                        CachedNetworkImage(
                                                                          imageUrl: "${food.attachements!.length != 0 ? food.attachements![0].url : "https://www.linkpicture.com/q/WhatsApp-Image-2023-02-16-at-12.46.25-PM.jpeg"}",
                                                                      fit: BoxFit
                                                                          .cover,
                                                                      width:
                                                                          140,
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Column(
                                                                    children: [
                                                                      if (food.isRequestSent == 0 &&
                                                                          !(food.isRequestReceived == 1 ||
                                                                              food.isRequestReceivedAccept ==
                                                                                  1 ||
                                                                              food.isRequestSentAccept ==
                                                                                  1 ||
                                                                              food.isRequestSentReject ==
                                                                                  1 ||
                                                                              food.isRequestReceivedReject ==
                                                                                  1)) ...[
                                                                        InkWell(
                                                                          onTap:
                                                                              () {
                                                                            ...
                                                                            Dialogs.materialDialog(
                                                                                useSafeArea: true,
                                                                                msg: "Sent Proposal",
                                                                                msgStyle: TextStyle(fontFamily: "Raleway", fontWeight: FontWeight.w500, color: Color(0xFF134FAF), fontSize: 25),
                                                                                                ...
                                                                                                Row(
                                                                                                  children: [
                                                                                                    ...
                                                                                                    ElevatedButton(
                                                                                                      ...
                                                                                                      child: Text('okay'.tr),
                                                                                                      onPressed: () {
                                                                                                        controller.sentRequestProposal(food.userId, context);
                                                                                                ...
                                                                                                Row(
                                                                                                  children: [
                                                                                                    ...
                                                                                                    ElevatedButton(
                                                                                                      ...
                                                                                                      child: Text('okay'.tr),
                                                                                                      onPressed: () {
                                                                                                        print(food.requestSent![0].id);
                                                                                                        // withdraw
                                                                                                        controller.withdrawProposal(food.requestSent![0].id, context);
                                                                      ...
                                                                      ] else if (food.isRequestSentAccept ==
                                                                              0 &&
                                                                          !(food.isRequestReceived == 1 ||
                                                                              food.isRequestReceivedAccept ==
                                                                                  1 ||
                                                                        ...
                                                                        InkWell(
                                                                          onTap:
                                                                              () {
                                                                            // sentrequest
                                                                            controller.sentRequestProposal(food.userId,
                                                                                context);
                                                                          },
                                                                          child:
                                                                              Container(
                                                                      ...
                                                                      ] else if (food.isRequestSentReject ==
                                                                              0 &&
                                                                          !(food.isRequestReceived == 1 ||
                                                                              food.isRequestReceivedAccept ==
                                                                                  1 ||
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            InkWell(
                                                                              onTap: () {
                                                                                Dialogs.materialDialog(useSafeArea: true, msg: "Accept Proposal", msgStyle: TextStyle(fontFamily: "Raleway", fontWeight: FontWeight.w500, color: Color(0xFF134FAF), fontSize: 25), color: Color(0xffEAF12D), context: context, dialogWidth: kIsWeb ? 0.3 : null, onClose: (value) => print("returned value is '$value'"), actions: [
                                                                                  SizedBox(
                                                                                      height: 120,
                                                                                      child: SingleChildScrollView(
                                                                                        child: Column(children: [
                                                                                                ...
                                                                                                Row(
                                                                                                  children: [
                                                                                                    ...
                                                                                                    ElevatedButton(
                                                                                                      ...
                                                                                                      child: Text('okay'.tr),
                                                                                                      onPressed: () {
                                                                                                        controller.acceptProposal(food.requestRecivied![0].id, context);
                                                                            ...
                                                                            InkWell(
                                                                              onTap: () {
                                                                                Dialogs.materialDialog(useSafeArea: true, msg: "Reject Proposal", msgStyle: TextStyle(fontFamily: "Raleway", fontWeight: FontWeight.w500, color: Color(0xFF134FAF), fontSize: 25), color: Color(0xffEAF12D), context: context, dialogWidth: kIsWeb ? 0.3 : null, onClose: (value) => print("returned value is '$value'"), actions: [
                                                                                  SizedBox(
                                                                                      height: 120,
                                                                                      child: SingleChildScrollView(
                                                                                        child: Column(children: [
                                                                                                ...
                                                                                                Row(
                                                                                                  children: [
                                                                                                    ...
                                                                                                    ElevatedButton(
                                                                                                      ...
                                                                                                      child: Text('okay'.tr),
                                                                                                      onPressed: () {
                                                                                                        controller.rejectProposal(food.requestRecivied![0].id, context);
