                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text("Account info", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, fontFamily: "Raleway", color: Color(0xFF134FAF)),),
                                            ),
                                            SizedBox(height: 15,),
                                            Padding(
                                              padding: const EdgeInsets.only(left: 15, top: 20),
                                              child: Text("Are you sure want to de-active account?", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, fontFamily: "Raleway", color: Color(0xFF134FAF)),),
                                            ),
                                            SizedBox(height: 25,),
                                            Row(
                                                children: [
                                                  Expanded(
                                                    child: InkWell(
                                                                                    onTap:
                                                                                        () {
                                                                                      controller.checkInput2(context);
                                                                                    },
                                                                                    child:
                                                                                        Container(
                                                                                      width:
                                                  ...
                                                  Expanded(
                                                    child: InkWell(
                                                                                    onTap:
                                                                                        () {
                                                                                      controller.checkInput3(context);
                                                                                    },
                                                                                    child:
                                                                                        Container(
                                                                                      width:
