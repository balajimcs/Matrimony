...
import '../../controller/update_controllers/profile_controller.dart';

class BasicEmailInfo extends StatefulWidget {
  State<BasicEmailInfo> createState() => BasicEmailInfoState();
}

class BasicEmailInfoState extends State<BasicEmailInfo> {
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text("Change Email Id", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, fontFamily: "Raleway", color: Color(0xFF134FAF)),),
                                            ),
                                            SizedBox(height: 25,),
                                            Padding(
                                              padding: const EdgeInsets.only(left: 25, right: 25),
                                              child: TextFormField(
                                          controller: controller.CurrentEmailId,
                                          style: TextStyle(color: Colors.black, fontFamily: "Raleway",fontSize: 16),
                                          decoration: InputDecoration(
                                            fillColor: Colors.grey.withOpacity(0.2),
                                            filled: true,
                                            hintText: "Current Email Id",
                                            ...
                                            SizedBox(height: 35,),
                                             Padding(
                                               ...
                                               child: InkWell(
                                                                                    onTap:
                                                                                        () {
                                                                                      controller.checkInput1(context);
                                                                                    },
                                                                                    child:
                                                                                        Container(
                                                                                      width:
