...
class ProposalReceived extends StatefulWidget {
  State<ProposalReceived> createState() => ProposalReceivedState();
}

class ProposalReceivedState extends State<ProposalReceived> {
...
triggerMode: RefreshIndicatorTriggerMode.onEdge,
        ...
        child: Stack(
          children: <Widget>[
            ...
            Container(
              margin:
                  EdgeInsets.only(top: MediaQuery.of(context).size.height / 4.4),
              width: double.infinity,
            ...
            Padding(
              ...
              child: Container(
                  child: StreamBuilder<List<receiviedProprosalModel>>(
                          ...
                          default:
                            if (snapshot.hasError) {
                              ...
                              print(snapshot.data);
                               ...
                               List<receiviedProprosalModel> foodList = snapshot.data!
                            .where((item) =>
    ...
    MaterialPageRoute(builder: (context) => DetailPage(idMatch: food.userId,)));
                                          ...
                                          child: Center(
                                            child: Padding(
                                              ...
                                              child: Obx(() => controller.isLoader.value ? Container() :
                                                Card(
                                                  elevation: 50,
                                        ...
                                        child: SingleChildScrollView(
                                          child: Column(children: [
                                            Container(
                                              ...
                                              child: Text("Did you want to accept the request", textAlign: TextAlign.center,style: TextStyle(fontFamily: "Raleway",
                                                        fontWeight: FontWeight.bold,
                                    ...
                                    SizedBox(
                                        ...
                                        child: SingleChildScrollView(
                                          child: Column(children: [
                                            Container(
                                              alignment: Alignment.center,
                                              child: Text("Did you want to reject the request", textAlign: TextAlign.center,style: TextStyle(fontFamily: "Raleway",
                                                        fontWeight: FontWeight.bold,
                                                        color: Colors.black, fontSize: 17),),
                                            ),
                                             SizedBox(
