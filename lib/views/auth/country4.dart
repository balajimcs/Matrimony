...
class CountryStateCityPicker2 extends StatefulWidget {
  ...
  CountryStateCityPicker2({required this.distict,required this.country, required this.state,  this.textFieldInputBorder, });

  @override
  _CountryStateCityPickerState createState() => _CountryStateCityPickerState();
}

class _CountryStateCityPickerState extends State<CountryStateCityPicker2> {
