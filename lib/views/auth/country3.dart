...
class CountryStateCityPicker1 extends StatefulWidget {
  ...
  CountryStateCityPicker1({required this.distict,required this.country, required this.state,  this.textFieldInputBorder, });

  @override
  _CountryStateCityPickerState createState() => _CountryStateCityPickerState();
}

class _CountryStateCityPickerState extends State<CountryStateCityPicker1> {
                      ...
                      TextButton(
                        onPressed: (){
                          if(_title=='City' && _citySubList.isEmpty){
                            widget.distict.text= _controller4.text;
                          }
                          _countrySubList=_countryList;
                          _stateSubList = _stateList;
                          _citySubList = _cityList;
