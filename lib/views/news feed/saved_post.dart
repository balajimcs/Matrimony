...
import 'package:thirumanam/models/saved_feed_model.dart';
...
class SavedFeedPost extends StatefulWidget {
  @override
  State<SavedFeedPost> createState() => SavedFeedPostState();
}

class SavedFeedPostState extends State<SavedFeedPost> {
     ...
     return Scaffold(
      ...
      child: Image(image:NetworkImage(controller1.profileattachemnts.value,
        ...
        fit: BoxFit.fill,
            ...
            child: Container(
              child: StreamBuilder<List<SavedpostFeedModel>>(
                  
                  stream: controller.getSavedPostModel(),
                   initialData: [],
        ...
        // DateFormat formattedDate = DateFormat('yyyy-MM-dd').format(DateTime.parse("${food.time}")) as DateFormat;
        DateTime time1 = format.parse("${food.time}");
        // DateTime time1 = formattedDate as DateTime;
        print(time1);
                                          ...
                                          child:  Column(
                                              ...
                                              children: [
                                                Align(
                                                  ...
                                                  child: Text(
                                                    maxLines: 2, 
                                                    "${food.firstName} ${food.lastName}", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, fontFamily: "Raleway", ),)),
                                                  SizedBox(height: 7,),
                                                Row(
                                                  children: [
